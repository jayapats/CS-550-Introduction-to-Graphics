...
const char* WINDOWTITLE = { "OpenGL / GLUT Sample -- Final Project_Jayapats" };
...
int Height_Mercury, Height_Venus, Height_Earth, Height_Mars, Height_Jupiter, Height_Saturn, Height_Uranus, Height_Neptune;
int Width_Mercury, Width_Venus, Width_Earth, Width_Mars, Width_Jupiter, Width_Saturn, Width_Uranus, Width_Neptune;
